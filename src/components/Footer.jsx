      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 gap-10">
          ...
          <div className="flex items-center gap-8">
            {[
              { label: 'GitHub', icon: <GitHubIcon size={24} />, href: 'https://github.com/AaryaBalan' },
              { label: 'LinkedIn', icon: <LinkedInIcon size={24} />, href: 'https://www.linkedin.com/in/aaryabalan/' },
              { label: 'LeetCode', icon: <LeetCodeIcon size={24} />, href: 'https://leetcode.com/u/_aarya_/' },
              { label: 'Send Email', icon: <MailIcon size={24} />, href: 'mailto:aaryabalan2006@gmail.com' },
            ].map(link => (
              <a
                key={link.label}
                href={link.href}
